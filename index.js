...
class ISYThermostatAccessory extends ISYBaseAccessory {
	...
	handleExternalChange() {
		...
		this.thermostatService
			.updateCharacteristic(Characteristic.CoolingThresholdTemperature, this.toCelsius(this.device.getCoolSetPoint()));
		this.thermostatService
			.updateCharacteristic(Characteristic.HeatingThresholdTemperature, this.toCelsius(this.device.getHeatSetPoint()));
		this.thermostatService
			.updateCharacteristic(Characteristic.TargetHeatingCoolingState, this.device.getHeatingCoolingMode());
		this.thermostatService
			.updateCharacteristic(Characteristic.CurrentHeatingCoolingState, this.device.getHeatingCoolingState());
		this.thermostatService
			.updateCharacteristic(Characteristic.CurrentFanState, this.device.getFanState());
		this.thermostatService
			.updateCharacteristic(Characteristic.CurrentRelativeHumidity, this.device.getHumidity());
	}
...
class ISYOutletAccessory extends ISYBaseAccessory {
	...
	handleExternalChange() {
		this.outletService
			.updateCharacteristic(Characteristic.On, this.device.getCurrentOutletState());
	}
...
class ISYLockAccessory extends ISYBaseAccessory {
	...
	handleExternalChange() {
		this.lockService
			.updateCharacteristic(Characteristic.LockTargetState, this.getDeviceCurrentStateAsHK());
		this.lockService
			.updateCharacteristic(Characteristic.LockCurrentState, this.getDeviceCurrentStateAsHK());
	}
	// Returns the set of services supported by this object.
	getServices() {
		super.getServices();
