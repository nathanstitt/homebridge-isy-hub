...
import { Categories, DeviceTypes, Families, NodeTypes, Props, States, VariableTypes } from './constants';
import { ISYDevice } from './device';
import { ISYNode } from './node';
import ProductInfoData from './productinfo.json';
import { ISYScene } from './scene';
import { ISYVariable } from './variable';
...
export class ISY {
    ...
    public sendGetVariable(id, type, handleResult) {
        ...
        rest.get(uriToUse, options).on('complete', (result, response) => {
