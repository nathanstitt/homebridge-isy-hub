...
var ISYThermostatAccessory = function (_ISYBaseAccessory) {
	...
	_createClass(ISYThermostatAccessory, [{
		...
		key: "calcTargetTemperature",
		value: function calcTargetTemperature() {
			var heatSetPoint = this.device.getHeatSetPoint();
			var coolSetPoint = this.device.getCoolSetPoint();
			var currentTemperature = this.device.getCurrentTemperature();
			if (currentTemperature > heatSetPoint) {
				if (currentTemperature <= coolSetPoint) return currentTemperature;else return coolSetPoint;
